...
exports.handler = (event, context, callback) => {
        ...
        mongoose.connect("mongodb://172.31.9.174/myDB",{useMongoClient: true});
       
        var query = {$and:[{ "department": event.department},{"category":event.category},{"subCategory":event.subCategory},{"minCet":{ $lt: event.minCet }}]};

        //var query = {$and:[{ "collegeName": event.collegeName},{"category":event.category},"subCategory":event.subCategory,"minCet":{ $lt: event.minCet }}};
